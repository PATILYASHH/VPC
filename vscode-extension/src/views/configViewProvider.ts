...
export class ConfigViewProvider implements vscode.WebviewViewProvider {
  public static readonly viewType = 'vpcSync.config';
  private _view?: vscode.WebviewView;
  private client: SyncApiClient;
  private onConfigured: () => void;

  constructor(client: SyncApiClient, onConfigured: () => void) {
    this.client = client;
  ...
  private getHtml(): string {
    ...
    const outputFolder = config.get<string>('outputFolder') || './migrations';
